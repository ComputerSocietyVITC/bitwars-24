    ...
    <>
      ...
      <div className="w-full" id="about">
        <div className="w-full flex flex-col mb-24">
          ...
          <div className="w-full sm:w-2/3 lg:w-2/4 sm:ml-24 md:ml-36 lg:ml-48 mt-14 rounded-2xl text-center bg-gradient-to-br from-[#100e1773] via-[#10345676] to-[#100e177e] border border-white/[0.2]">
