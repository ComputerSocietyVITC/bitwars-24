      ...
      >
        ...
        <div className="px-4">
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent className="text-white text-left accord-cont p-4 leading-relaxed">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam aperiam, sapiente nulla labore voluptas culpa incidunt perferendis necessitatibus corrupti debitis ipsum ullam odio hic! Ipsum laborum eligendi provident, voluptatum odit at nesciunt eveniet repellendus officia! Quae, vitae animi quidem repellat provident in nobis quis quisquam, dolores perferendis, totam voluptate numquam.
            </AccordionContent>
          </AccordionItem>
